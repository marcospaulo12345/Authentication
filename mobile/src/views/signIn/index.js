...
export default function SignIn() {
    return (
        <>
            <KeyboardAvoidingView behavior='height' keyboardVerticalOffset={30} style={styles.container}>
                
                    <Svg width="414" height="360" style={styles.teste} viewBox="0 0 414 380" fill="none" xmlns="http://www.w3.org/2000/svg">
